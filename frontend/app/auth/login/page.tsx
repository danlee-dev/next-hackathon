    ...
    <main className="relative grid min-h-dvh place-items-center bg-black px-6 text-white">
      ...
      <div className="relative w-full max-w-[420px]">
        ...
        <div className="mb-2 font-mono text-[10.5px] uppercase tracking-[0.32em] text-white/45">
          {mode === "sign-in" ? "01 · Welcome back" : "01 · New account"}
        </div>
        <h1
        ...
        <p className="mt-3 text-[14px] leading-[1.55] text-white/55">
          한국 IR 발표에 특화된 AI 코칭. 60초로 신뢰를 측정합니다.
        </p>

        <form onSubmit={onEmail} className="mt-10 flex flex-col gap-4">
          <Field
            id="email"
            label="Email"
            type="email"
          ...
          <button
            type="submit"
            disabled={loading}
            className="group mt-2 inline-flex h-12 items-center justify-center gap-2 rounded-full bg-white px-5 text-[14px] font-semibold text-black transition-transform hover:scale-[1.02] disabled:opacity-50"
          >
        ...
        <div className="my-7 flex items-center gap-3 font-mono text-[10px] uppercase tracking-[0.32em] text-white/30">
        ...
        <button
          ...
          onClick={onGoogle}
          disabled={loading}
          className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-full border border-white/15 px-5 text-[14px] font-medium text-white transition-colors hover:border-white/35 hover:bg-white/[0.04] disabled:opacity-50"
        >
          <GoogleMark />
          Google로 계속하기
        </button>
        ...
        <button
          ...
          className="mt-8 w-full text-center font-mono text-[10.5px] uppercase tracking-[0.32em] text-white/45 transition-colors hover:text-white"
        >
